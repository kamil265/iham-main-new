                        ...
                        {		
                            ...
                            if($j == 1){
                                ...
                                if($same == 0){
                                    ...
                                    {											
                                            $data = "INSERT INTO tb_area_1(rfid_uid,total,posX,posY,kondisi,nama_anak)
                                            VALUES ('$id','$new_tot','$posX','$Ynew','$same','$name')";
                                            $run_1 = mysqli_query($connection, $data);										
                                    }																																	
                                }
                            ...
                            if($j==2) 
                            {
                                ...
                                if($same == 0)
                                {
                                    ...
                                    $Ynew = $new_Y+ 20;								
                                    foreach ($posX as $x){
                                        $data = "INSERT INTO tb_area_2 (rfid_uid,total,posX, posY,kondisi,nama_anak)
                                                VALUES ('$id','$new_tot', '$x' , '$Ynew','$same','$name')";
                            ...
                            else 
                            {
                                ...
                                if($same == 0)
                                {
                                    ...
                                    if ($con == 2)
                                    {
                                        $data = "INSERT INTO tb_area_3 (rfid_uid,total,posX,posY,kondisi,nama_anak)
                                        VALUES ('$id','$new_tot','$posX[0]','$Ynew','$same','$name')";
                                        $run_3 = mysqli_query($connection, $data);
                                    }
                                    else
                                    {										
                                ...
                                $delete = " DELETE FROM tb_	area_3 WHERE posX != 78 ";
