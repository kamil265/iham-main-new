				...
				<body oncontextmenu="return false;">
					<div class="stand">
						...
						foreach($object as $j){
							...
							$delete3 = "DELETE FROM tb_area_3 WHERE posX = 0";
							$exe2 = mysqli_query($connection, $delete3);
							$delete2 = "DELETE FROM tb_area_2 WHERE posX = 0";
							$exe2 = mysqli_query($connection, $delete2);
							$delete1 = "DELETE FROM tb_area_1 WHERE posX = 0";
							$exe1 = mysqli_query($connection, $delete1);
						//Filter Data
						//initiialization
						$t_1 = 0;
						$t_2 = 0;
