...
include'connect.php';
		if(isset($_POST['updateBayi']))
		{
            ...
            $id=intval($_GET['id']);
			$sql="UPDATE rekammedis  set kode_rfid=:inkode_rfid,nama=:innama,poli=:inpoli,usia=:inusia,diagnosa=:indiagnosa,gol_darah=:ingol_darah,tb=:intb,bb=:inbb,hasil_diagnosa=:inhasil_diagnosa where id=:id AND kategori_pasien='Bayi'";
