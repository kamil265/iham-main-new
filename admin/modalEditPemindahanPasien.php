    ...
    <div class="modal-dialog modal-lg">
        ...
        <form action="editPemindahanPasien.php?id=<?php echo htmlentities ($result->id);?>" method="POST"  class="step-form-horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-2">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="asal_ruang" id="asal_ruang" value="<?php echo htmlentities($result->asal_ruang);?>" class="form-control" required>
                                    <!-- <select class="form-control" name="asal_ruang" id="asal_ruang" value="#" class="form-control" required>
                            ...
                            <div class="col-lg-12 mb-2">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="ruang_pemindahan" id="ruang_pemindahan" value="<?php echo htmlentities($result->ruang_pemindahan);?>" class="form-control" required>
                                    <!-- <select class="form-control" name="ruang_pemindahan" id="ruang_pemindahan" value="#" class="form-control" required>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="updatePemindahanPasien" class="btn btn-primary">Edit</button>
                </div>
            </form>
        </div>
        </div>
